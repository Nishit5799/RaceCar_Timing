    ...
    <>
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-80 z-50 start">
          <div className="text-center">
            ...
            <div
              ...
              className="mt-4 py-2 font-choco text-white sm:text-2xl text-3xl tracking-widest cursor-pointer bg-green-500 hover:bg-green-600 sm:w-[50%] w-[57%] h-[30%] mx-auto rounded-lg transition-colors"
            >
              PLAY GAME
            </div>
            <div
            ...
            <Link
              href="https://multiplayercarracing-production.up.railway.app/"
              className="block mt-4"
            >
              <div className="py-2 font-choco text-white sm:text-2xl text-3xl tracking-widest cursor-pointer bg-red-500 hover:bg-red-600 sm:w-[50%] w-[57%] h-[30%] mx-auto rounded-lg transition-colors">
                EXIT
              </div>
            </Link>
          </div>
      ...
      {isGameStarted && (
        <div className="fixed bottom-4 left-4 z-50">
          <Link href="https://multiplayercarracing-production.up.railway.app/">
            <div className="py-2 px-4 font-choco text-white text-xl tracking-widest cursor-pointer bg-red-500 hover:bg-red-600 rounded-lg transition-colors">
              EXIT
            </div>
          </Link>
        </div>
